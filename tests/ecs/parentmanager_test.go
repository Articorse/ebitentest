...
func TestGetOrderedHierarchies(t *testing.T) {
	...
	ecsContainer.AddComponent(0, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(1, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(2, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(3, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(4, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(5, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(6, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(7, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(8, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(9, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(10, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(11, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(12, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(13, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(14, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(15, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(16, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(17, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(18, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(19, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(20, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(21, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(22, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(23, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(24, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
	ecsContainer.AddComponent(25, ecs.NewTransformComponent(utils.Vec2{X: 0, Y: 0}, 1, 0))
