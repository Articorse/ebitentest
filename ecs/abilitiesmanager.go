...
func (abilitiesManager) TickAbilities(e common.EntityId, ecs *ECS) error {
	abiComp, err := ecs.Abilities.getComponent(e)
	if err != nil {
...
func (abilitiesManager) HasAbility(e common.EntityId, name AbilityEnum, ecs *ECS) bool {
	abiComp, err := ecs.Abilities.getComponent(e)
	if err != nil {
		return false
	}
...
func (abilitiesManager) DisableAbility(e common.EntityId, name AbilityEnum, ecs *ECS) error {
	abiComp, err := ecs.Abilities.getComponent(e)
	if err != nil {
		return fmt.Errorf("could not get abilities component of entity %d: %v", e, err)
	}
...
func (abilitiesManager) EnableAbility(e common.EntityId, name AbilityEnum, ecs *ECS) error {
	abiComp, err := ecs.Abilities.getComponent(e)
	if err != nil {
		return fmt.Errorf("could not get abilities component of entity %d: %v", e, err)
	}
...
func (abilitiesManager) ActivateAbility(
	...
	_, err = tryActivate(e, &abi, targets, targetPos, ecs)
	if err != nil {
