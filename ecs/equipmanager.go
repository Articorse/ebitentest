...
func (equipManager) GetEquipmentEntities(
	...
	equipperComp, err := ecsContainer.Equippers.getComponent(e)
	if err != nil {
...
func (equipManager) ActivateAbility(
	...
	eqE, hasEq, err := em.GetEquipmentInSlot(e, slot, ecsContainer)
	if err != nil {
	...
	equipmentComp, err := ecsContainer.Equipments.getComponent(eqE)
	if err != nil {
...
func (equipManager) TickAbilities(e common.EntityId, ecsContainer *ECSContainer) error {
	equipmentComp, err := ecsContainer.Equipments.getComponent(e)
	if err != nil {
